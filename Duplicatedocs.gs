...
function createNewGoogleDocs() {
  ...
  const googleDocTemplate = DriveApp.getFileById('1Lg3Wlmh7q53pCj2FiWPxP77gQ-bY49-jaWV5L4undAM');
  
  //This value should be the id of the folder where you want your completed documents stored
  const destinationFolder = DriveApp.getFolderById('1DmxhvzWxtlDiDAbizkT5xvUoG0vSa35J')
